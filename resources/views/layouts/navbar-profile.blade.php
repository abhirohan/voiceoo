	...
	<div class="header-content-wrapper">
		<form class="search-bar w-search notification-list friend-requests">
			<div class="form-group with-button">
				...
				<button>
					<svg class="olymp-magnifying-glass-icon"><use xlink:href="{{ route('basepath') }}/icons/icons.svg#olymp-magnifying-glass-icon"></use></svg>
				</button>
			</div>
		</form>
			...
			<div class="control-icon more has-items">
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					<div class="ui-block-title ui-block-title-small">
						...
						<a href="{{ route('accountSetting') }}">Settings</a>
					</div>
						...
						<ul class="notification-list friend-requests">
							<li>
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar55-sm.jpg" alt="author">
								</div>
							...
							<li>
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar56-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
							...
							<li class="accepted">
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar57-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
							...
							<li>
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar58-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
					...
					<div class="mCustomScrollbar" data-mcs-theme="dark">
						<ul class="notification-list chat-message">
							<li class="message-unread">
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar59-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
							...
							<li>
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar60-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
							...
							<li>
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar61-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
							...
							<li class="chat-group">
								...
								<div class="more">
									<svg class="olymp-three-dots-icon"><use xlink:href="{{ route('basepath') }}/sicons/icons.svg#olymp-three-dots-icon"></use></svg>
								</div>
							</li>
						</ul>
					</div>
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					...
					<div class="mCustomScrollbar" data-mcs-theme="dark">
						<ul class="notification-list">
							<li>
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar62-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
							...
							<li class="un-read">
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar63-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
							...
							<li class="with-comment-photo">
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar64-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
								...
								<div class="comment-photo">
									<img src="{{ route('basepath') }}/img/comment-photo1.jpg" alt="photo">
							...
							<li>
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar65-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
							...
							<li>
								<div class="author-thumb">
									<img src="{{ route('basepath') }}/img/avatar66-sm.jpg" alt="author">
								</div>
								<div class="notification-event">
